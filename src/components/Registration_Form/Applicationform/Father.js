...
const Father= ({applicationForm, setApplicationForm,steps,setSteps}) => {
    ...
    const changeHandler = e => {
     ...
     //validation function
     const validate = (fieldValues = father) => {
        let temp = { ...errors };
    ...
    return (
      <div>
        ...
        <Grid container xs={12} sm={12} md={4} rowSpacing={2} justifyContent="center">  
            ...
            <TextField
                    required
                    value={father.permanent_address}
                    onChange={changeHandler}
                    variant="outlined"
            ...
            <TextField
                    required
                    value={father.communication_address}
                    onChange={changeHandler}
                    variant="outlined"
            ...
            <TextField
                    required
                    value={father.aadhaar_card_number}
                    onChange={changeHandler}
                    variant="outlined"
